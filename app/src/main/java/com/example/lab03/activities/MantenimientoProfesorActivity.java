...
public class MantenimientoProfesorActivity extends AppCompatActivity
    ...
    //Url listar
    String apiUrl = "http://192.168.0.19:8080/Backend_JSON/modelos/profesor/list?";//Esta para mi celular ip de mi compu la ipv4 de mi LAN
    //String apiUrl = "http://10.0.2.2:8080/Backend_JSON/modelos/profesor/list";//Esta para emulador

    //Url agregar
    String apiUrlAcciones= "http://192.168.0.19:8080/Backend_JSON/Controlador/profesor?";
